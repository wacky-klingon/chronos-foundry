...
### Architecture & Design
- **[System Overview](../architecture/overview.md)** - Unified system overview and MVP capabilities
- **[System Architecture](../architecture/system-architecture.md)** - Design principles, data flow, Design FAQ
...
### For Developers:
1. Read [Overview](../architecture/overview.md) to understand MVP capabilities
